...
import type { DataObject, PermissionsChange, PrivilegeAssignment, Share, ShareSchema } from "./models_pb";
 ...
 */
export type GetPermissionsRequest = Message<"unitycatalog.shares.v1.GetPermissionsRequest"> & {
  /**
   * Name of the share.
   *
   * @generated from field: string name = 1;
 ...
 */
export type GetPermissionsResponse = Message<"unitycatalog.shares.v1.GetPermissionsResponse"> & {
  /**
 ...
 */
export type UpdatePermissionsRequest = Message<"unitycatalog.shares.v1.UpdatePermissionsRequest"> & {
  /**
   * Name of the share.
   *
   * @generated from field: string name = 1;
 ...
 */
export type UpdatePermissionsResponse = Message<"unitycatalog.shares.v1.UpdatePermissionsResponse"> & {
  /**
   * The privileges assigned to each principal
   *
   * @generated from field: repeated unitycatalog.shares.v1.PrivilegeAssignment privilege_assignments = 1;
