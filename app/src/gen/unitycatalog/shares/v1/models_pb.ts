 ...
 */
export const DataObjectSchema: GenMessage<DataObject, {jsonType: DataObjectJson}> = /*@__PURE__*/
 ...
 */
export const ShareInfoSchema: GenMessage<ShareInfo, {jsonType: ShareInfoJson}> = /*@__PURE__*/
