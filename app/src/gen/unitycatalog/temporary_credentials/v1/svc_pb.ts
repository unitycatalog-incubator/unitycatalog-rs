 ...
 * @generated from message unitycatalog.temporary_credentials.v1.GenerateTemporaryTableCredentialsRequest
 */
export type GenerateTemporaryTableCredentialsRequestJson = {
  /**
   * The name of the table for which to generate credentials.
   *
   * @generated from field: string table_id = 1;
 ...
 */
export const GenerateTemporaryTableCredentialsRequestSchema: GenMessage<GenerateTemporaryTableCredentialsRequest, {jsonType: GenerateTemporaryTableCredentialsRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message unitycatalog.temporary_credentials.v1.GenerateTemporaryVolumeCredentialsRequest
 */
export type GenerateTemporaryVolumeCredentialsRequestJson = {
  /**
   * The name of the volume for which to generate credentials.
   *
   * @generated from field: string volume_id = 1;
 ...
 */
export const GenerateTemporaryVolumeCredentialsRequestSchema: GenMessage<GenerateTemporaryVolumeCredentialsRequest, {jsonType: GenerateTemporaryVolumeCredentialsRequestJson}> = /*@__PURE__*/
 ...
 * @generated from enum unitycatalog.temporary_credentials.v1.Operation
 */
export type OperationJson = "OPERATION_UNSPECIFIED" | "READ" | "READ_WRITE";
