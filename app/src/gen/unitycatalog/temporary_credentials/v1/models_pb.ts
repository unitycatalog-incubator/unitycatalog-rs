 ...
 */
export const file_unitycatalog_temporary_credentials_v1_models: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate]);

/**
 * @generated from message unitycatalog.temporary_credentials.v1.AzureUserDelegationSas
 */
export type AzureUserDelegationSas = Message<"unitycatalog.temporary_credentials.v1.AzureUserDelegationSas"> & {
  /**
 ...
 * @generated from message unitycatalog.temporary_credentials.v1.AzureUserDelegationSas
 */
export type AzureUserDelegationSasJson = {
  /**
   * The signed URI (SAS Token) used to access blob services for a given path
   *
   * @generated from field: string sas_token = 1;
 ...
 */
export const AzureUserDelegationSasSchema: GenMessage<AzureUserDelegationSas, {jsonType: AzureUserDelegationSasJson}> = /*@__PURE__*/
 ...
 */
export type AzureAad = Message<"unitycatalog.temporary_credentials.v1.AzureAad"> & {
  /**
 ...
 */
export const AzureAadSchema: GenMessage<AzureAad, {jsonType: AzureAadJson}> = /*@__PURE__*/
 ...
 */
export type R2TemporaryCredentials = Message<"unitycatalog.temporary_credentials.v1.R2TemporaryCredentials"> & {
  /**
 ...
 * @generated from message unitycatalog.temporary_credentials.v1.R2TemporaryCredentials
 */
export type R2TemporaryCredentialsJson = {
  /**
   * The access key ID that identifies the temporary credentials.
   *
   * @generated from field: string access_key_id = 1;
 ...
 */
export const R2TemporaryCredentialsSchema: GenMessage<R2TemporaryCredentials, {jsonType: R2TemporaryCredentialsJson}> = /*@__PURE__*/
 ...
 */
export type GcpOauthToken = Message<"unitycatalog.temporary_credentials.v1.GcpOauthToken"> & {
  /**
 ...
 */
export const GcpOauthTokenSchema: GenMessage<GcpOauthToken, {jsonType: GcpOauthTokenJson}> = /*@__PURE__*/
 ...
 */
export type AwsTemporaryCredentials = Message<"unitycatalog.temporary_credentials.v1.AwsTemporaryCredentials"> & {
  /**
   * The access key ID that identifies the temporary credentials.
   *
   * @generated from field: string access_key_id = 1;
   ...
   *
   * @generated from field: string access_point = 4;
   */
  accessPoint: string;
};
 ...
 * @generated from message unitycatalog.temporary_credentials.v1.AwsTemporaryCredentials
 */
export type AwsTemporaryCredentialsJson = {
  /**
   * The access key ID that identifies the temporary credentials.
   *
   * @generated from field: string access_key_id = 1;
 ...
 */
export const AwsTemporaryCredentialsSchema: GenMessage<AwsTemporaryCredentials, {jsonType: AwsTemporaryCredentialsJson}> = /*@__PURE__*/
 ...
 */
export type TemporaryCredential = Message<"unitycatalog.temporary_credentials.v1.TemporaryCredential"> & {
  /**
 ...
 * @generated from message unitycatalog.temporary_credentials.v1.TemporaryCredential
 */
export type TemporaryCredentialJson = {
  /**
   * Server time when the credential will expire, in epoch milliseconds.
   * The API client is advised to cache the credential given this expiration time.
   *
   ...
   * @generated from field: unitycatalog.temporary_credentials.v1.AzureUserDelegationSas azure_user_delegation_sas = 100;
   */
  azureUserDelegationSas?: AzureUserDelegationSasJson;
   ...
   * @generated from field: unitycatalog.temporary_credentials.v1.AwsTemporaryCredentials aws_temp_credentials = 102;
   */
  awsTempCredentials?: AwsTemporaryCredentialsJson;
   ...
   * @generated from field: unitycatalog.temporary_credentials.v1.GcpOauthToken gcp_oauth_token = 103;
   */
  gcpOauthToken?: GcpOauthTokenJson;
   ...
   * @generated from field: unitycatalog.temporary_credentials.v1.R2TemporaryCredentials r2_temp_credentials = 104;
   */
  r2TempCredentials?: R2TemporaryCredentialsJson;
};
 ...
 */
export const TemporaryCredentialSchema: GenMessage<TemporaryCredential, {jsonType: TemporaryCredentialJson}> = /*@__PURE__*/
