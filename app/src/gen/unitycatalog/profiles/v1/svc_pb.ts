 ...
 */
export const CreateProfileRequestSchema: GenMessage<CreateProfileRequest, {jsonType: CreateProfileRequestJson}> = /*@__PURE__*/
 ...
 */
export const CreateProfileResponseSchema: GenMessage<CreateProfileResponse, {jsonType: CreateProfileResponseJson}> = /*@__PURE__*/
