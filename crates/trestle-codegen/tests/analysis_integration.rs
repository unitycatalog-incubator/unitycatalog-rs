...
use rstest::rstest;
use trestle_codegen::analysis::{RequestType, analyze_metadata};
use trestle_codegen::parsing::{CodeGenMetadata, parse_file_descriptor_set};
...
fn find_method_plan<'a>(
    plan: &'a trestle_codegen::analysis::GenerationPlan,
    service_name: &str,
    method_name: &str,
) -> &'a trestle_codegen::analysis::MethodPlan {
    plan.services
        .iter()
