...
impl serde::Serialize for CreateProfileRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("unitycatalog.profiles.v1.CreateProfileRequest", len)?;
        if !self.claims.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CreateProfileRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct unitycatalog.profiles.v1.CreateProfileRequest")
            }
        ...
        deserializer.deserialize_struct("unitycatalog.profiles.v1.CreateProfileRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CreateProfileResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("unitycatalog.profiles.v1.CreateProfileResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for CreateProfileResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct unitycatalog.profiles.v1.CreateProfileResponse")
            }
        ...
        deserializer.deserialize_struct("unitycatalog.profiles.v1.CreateProfileResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Profile {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("unitycatalog.profiles.v1.Profile", len)?;
        if self.share_credentials_version != 0 {
...
impl<'de> serde::Deserialize<'de> for Profile {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct unitycatalog.profiles.v1.Profile")
            }
        ...
        deserializer.deserialize_struct("unitycatalog.profiles.v1.Profile", FIELDS, GeneratedVisitor)
    }
}
