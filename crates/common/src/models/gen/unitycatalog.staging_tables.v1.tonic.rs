...
*/
        async fn create_staging_table(
            &self,
            request: tonic::Request<super::CreateStagingTableRequest>,
        ) -> std::result::Result<tonic::Response<super::StagingTable>, tonic::Status>;
    }
...
*/
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/unitycatalog.staging_tables.v1.StagingTablesService/CreateStagingTable" => {
                    #[allow(non_camel_case_types)]
                    struct CreateStagingTableSvc<T: StagingTablesService>(pub Arc<T>);
                    impl<
                        T: StagingTablesService,
                    > tonic::server::UnaryService<super::CreateStagingTableRequest>
                    for CreateStagingTableSvc<T> {
                        type Response = super::StagingTable;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as StagingTablesService>::create_staging_table(
                                        &inner,
                                        request,
                                    )
                                    .await
