...
impl<'de> serde::Deserialize<'de> for GetRecipientRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct unitycatalog.recipients.v1.GetRecipientRequest")
            }
...
impl serde::Serialize for Recipient {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("unitycatalog.recipients.v1.Recipient", len)?;
...
impl<'de> serde::Deserialize<'de> for Recipient {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("unitycatalog.recipients.v1.Recipient", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for RecipientToken {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct unitycatalog.recipients.v1.RecipientToken")
            }
