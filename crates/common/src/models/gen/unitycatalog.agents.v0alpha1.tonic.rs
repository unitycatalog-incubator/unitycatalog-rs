...
*/
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/unitycatalog.agents.v0alpha1.AgentsService/ListAgents" => {
                    #[allow(non_camel_case_types)]
                    struct ListAgentsSvc<T: AgentsService>(pub Arc<T>);
                    impl<
                        T: AgentsService,
                    ...
                    for ListAgentsSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AgentsService>::list_agents(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/unitycatalog.agents.v0alpha1.AgentsService/CreateAgent" => {
                    #[allow(non_camel_case_types)]
                    struct CreateAgentSvc<T: AgentsService>(pub Arc<T>);
                    impl<
                        T: AgentsService,
                    ...
                    for CreateAgentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentsService>::create_agent(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/unitycatalog.agents.v0alpha1.AgentsService/GetAgent" => {
                    #[allow(non_camel_case_types)]
                    struct GetAgentSvc<T: AgentsService>(pub Arc<T>);
                    impl<
                        T: AgentsService,
                    ...
                    for GetAgentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentsService>::get_agent(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/unitycatalog.agents.v0alpha1.AgentsService/UpdateAgent" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateAgentSvc<T: AgentsService>(pub Arc<T>);
                    impl<
                        T: AgentsService,
                    ...
                    for UpdateAgentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentsService>::update_agent(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/unitycatalog.agents.v0alpha1.AgentsService/DeleteAgent" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteAgentSvc<T: AgentsService>(pub Arc<T>);
                    impl<
                        T: AgentsService,
                    ...
                    for DeleteAgentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentsService>::delete_agent(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "unitycatalog.agents.v0alpha1.AgentsService";
