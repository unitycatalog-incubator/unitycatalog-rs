...
impl TableClient {
    ...
    pub async fn list_table_summaries(
        ...
        if let Some(ref value) = request.schema_name_pattern {
            url.query_pairs_mut().append_pair("schema_name_pattern", &value.to_string());
        }
        if let Some(ref value) = request.table_name_pattern {
            url.query_pairs_mut().append_pair("table_name_pattern", &value.to_string());
        }
    ...
    pub async fn list_tables(
        ...
        if let Some(ref value) = request.omit_columns {
            url.query_pairs_mut().append_pair("omit_columns", &value.to_string());
        }
        if let Some(ref value) = request.omit_properties {
            url.query_pairs_mut().append_pair("omit_properties", &value.to_string());
        }
        if let Some(ref value) = request.omit_username {
            url.query_pairs_mut().append_pair("omit_username", &value.to_string());
        }
